...
- Translate text typed or pasted into the popup. Translation runs on device with Chrome's built-in Translator API, and the draft is not saved to extension storage. No new clipboard permission is required.
